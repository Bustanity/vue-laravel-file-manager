export default {
  ...
  methods: {
    ...
    canView(extension) {
      ...
      return this.$store.state.fm.settings.pdfExtensions.includes(extension.toLowerCase())
        || this.$store.state.fm.settings.imageExtensions.includes(extension.toLowerCase());
    },
